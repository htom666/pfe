@extends('layout.main')
@section('content')
<form class="needs-validation" method="POST" action="{{ route('prospect.update', $prospect->id) }}">
    @method('PUT')
    @csrf
    <!-- Validation -->
                ...
                <div class="col-md-12 my-2">
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="nom" value="{{$prospect->nom}}" class="form-control" id="validationCustom01" placeholder="First name"  required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="prenom" value="{{$prospect->prenom}}" class="form-control" id="validationCustom02" placeholder="Last name" required>
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="metier" value="{{$prospect->metier}}" class="form-control" id="validationCustom02" placeholder="Last name" required>
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="city" value="{{$prospect->city}}"class="form-control" id="validationCustom03" placeholder="City" required>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="state" value="{{$prospect->state}}" class="form-control" id="validationCustom04" placeholder="State" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="zip" value="{{$prospect->zip}}" class="form-control" id="validationCustom05" placeholder="Zip" required>
                            <div class="invalid-feedback">
                        ...
                        <input type="text" name="email" value="{{$prospect->email}}" class="form-control" placeholder="Enter email here..." required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label for="exampleFormControlSelect1">Civility</label>
                                <select name="civilite" value="{{$prospect->civilite}}" class="form-control" id="civilite" required="">
                                    <option disabled="disabled" value="{{$prospect->civilite}}">Select</option>
                                    <option>Mrs</option>
                                    <option>Mr</option>
                                    <option>Ms</option>
                                </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="consentement" value="{{$prospect->consentement}}" class="form-control" placeholder="Enter consentement here..." required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="">Phone</label>
                            <input type="tel" name="telbureau" value="{{$prospect->telbureau}}" class="form-control" placeholder="Enter phone here..." required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="">Cell-phone</label>
                            <input type="tel" name="portable" value="{{$prospect->portable}}" class="form-control" placeholder="Enter cellphone here..." required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="">Telecopy</label>
                            <input type="tel" name="telecopie" class="form-control" value="{{$prospect->telecopie}}" placeholder="Enter telecopy here..." required>
                        </div>
