...
<div class="panel panel-light">
    <div class="panel-header">
        <h1 class="panel-title">{{$client->nom}} {{$client->prenom}}</h1>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 my-2">
                <ul class="nav nav-pills" id="pill-tabs-list" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active nav-link-primary" id="pill-tab-1" data-toggle="tab" href="#pill-tab-content-1" role="tab" aria-controls="pill-tab-content-1" aria-selected="true">Client details</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content p-3 mt-3" id="pill-tabs-content">
                    <div class="tab-pane fade show active" id="pill-tab-content-1" role="tabpanel" aria-labelledby="pill-tab-1">
                        ...
                        <p>Name : {{$client->nom}}</p>
                        <p>Last Name : {{$client->prenom}}</p>
                        <p>Job : {{$client->metier}}</p>
                        <p>Email : {{$client->email}}</p>
                        <p>Address : {{$client->city}} {{$client->state}} {{$client->zip}}</p>
                        <p>Phone : {{$client->telbureau}}</p>
                        <p>Cellphone : {{$client->portable}}</p>
                        <p>Telecopy : {{$client->telecopie}}</p>
                    </div>
