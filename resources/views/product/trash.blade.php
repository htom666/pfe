...
<div class="panel panel-light">
    <div class="panel-header">
        <h1 class="panel-title">Deleted Products</h1>
    </div>
    <div class="panel-body">
        @if (Session::has('success'))
            ...
            @endif
        <a href="{{route('product.create')}}" class="btn btn-info-lightened"><span>Add new product</span></a>
        <br>
        <br>
        <div class="row">
                    ...
                    <tbody>
                            ...
                            <td>{{$user->name}}</td>
                                  ...
                                  <td class="operations operations-buttons">
                                        ...
                                        <a href="{{ route('product.restore', $product->id ?? "") }}"  class="btn btn-sm btn-info-light">Restore</a>
