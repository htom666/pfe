                        ...
                        <form class="h-100" method="POST" action="{{ route('product.store') }}">
                            ...
                            <div class="form-group form-group-material form-group-material-outline">
                                <input type="text" name="name" value="{{ old('name') }}"
                                    class="form-control @error('name') error @enderror" autocomplete="off"
                                    id="form-group-material-outlined-1">
                                @error('name')
                                    <div class="error">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group form-group-material form-group-material-outline">
                                <input type="text" name="size" value="{{ old('size') }}"
                                    class="form-control @error('size') error @enderror" autocomplete="off"
                                    id="form-group-material-outlined-2">
                                @error('size')
                                    <div class="error">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group form-group-material form-group-material-outline">
                                <input type="text" name="quantity" value="{{ old('quantity') }}"
                                    class="form-control @error('quantity') error @enderror" autocomplete="off"
                                    id="form-group-material-outlined-1">
                                @error('quantity')
                                    <div class="error">
                                        {{ $message }}
                            ...
                            <div class="form-group form-group-material form-group-material-outline">
                                <input type="text" name="price" value="{{ old('price') }}" class="form-control"
                                    @error('price') error @enderror autocomplete="off" id="form-group-material-outlined-1">
                                @error('price')
                                    <div class="error">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group form-group-material form-group-material-outline">
                                <textarea name="description" class="form-control" autocomplete="off"
                                    id="form-group-material-outlined-3"></textarea>
