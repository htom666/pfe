...
<div class="panel panel-light">
 ...
 @endif
          ...
          <table class="table table-bordered table-fixed" id="window-overflow">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="operations">
                  <a href="{{ route('product.show',$product->id)}}" class="btn-icon btn btn-primary-light" data-toggle="tooltip" title="View">
                  ...
                  <a href="{{ route('product.edit',$product->id)}}" class="btn-icon btn btn-primary-light" data-toggle="tooltip" title="Edit">
                  ...
                  <a href="{{route('product.destroy',$product->id)}}" class="delete-btns btn-icon btn btn-danger-light" data-id="1" data-toggle="tooltip" title="Delete">
    ...
    <div class="col-md-4 mt-4">
      <button type="button" class="btn btn-info-lightened"  data-toggle="modal" data-target="#modal-fade-scale">Add Product</button>
    </div>
  </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="h-100" method="POST" action="{{ route('product.store') }}">
                  @csrf
                 ...
                 {{-- <div class="panel panel-light"> --}}
                     ...
                     <div class="form-group form-group-material form-group-material-outline">
                       ...
                       @error('name')
                           ...
                           @enderror
                       <label for="form-group-material-outlined-1">Product Name</label>
                       <span class="highlight"></span>
                       <span class="bar"></span>
                     </div>

                     <div class="form-group form-group-material form-group-material-outline">
                       <input type="text" name="size" value="{{old('size')}}" class="form-control @error('size') error @enderror" autocomplete="off" id="form-group-material-outlined-2" >
                       @error('size')
                       <div class="error">
                           {{ $message }}
                       </div>
                       @enderror
                       <label for="form-group-material-outlined-2">Size</label>
                       <span class="highlight"></span>
                       <span class="bar"></span>
                     </div>
                     ...
                     <div class="form-group form-group-material form-group-material-outline">
                      <input type="text" name="quantity" value="{{old('quantity')}}" class="form-control @error('quantity') error @enderror" autocomplete="off" id="form-group-material-outlined-1">
                      @error('quantity')
                      <div class="error">
                          {{ $message }}
                      </div>
                      @enderror
                      <label for="form-group-material-outlined-1">Quantity</label>
                      <span class="highlight"></span>
                      <span class="bar"></span>
                    </div>

                    <div class="form-group form-group-material form-group-material-outline">
                      <input type="text" name="price" value="{{old('price')}}" class="form-control"@error('price') error @enderror autocomplete="off" id="form-group-material-outlined-1">
                      @error('price')
                      <div class="error">
                          {{ $message }}
                      </div>
                     ...
                     <div class="form-group form-group-material form-group-material-outline">
                       <textarea name="description" class="form-control" autocomplete="off" id="form-group-material-outlined-3"></textarea>
                       <label for="form-group-material-outlined-3">Decription</label>
                       <span class="highlight"></span>
                       <span class="bar"></span>
                     </div>
