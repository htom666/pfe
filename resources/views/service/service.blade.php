        ...
        @foreach ($service as $service)
            <tr>
                ...
                <td class="operations">
                    ...
                    <a href="{{route('service.destroy',$service->id)}}" class="delete-btns btn-icon btn btn-danger-light" data-id="1" data-toggle="tooltip" title="Delete">
              ...
              <form class="h-100" method="POST" action="{{ route('service.store') }}">
               ...
               {{-- <div class="panel panel-light"> --}}
                   ...
                   <div class="form-group form-group-material form-group-material-outline">
                     <input type="text" name="name" class="form-control" autocomplete="off" id="form-group-material-outlined-1">
                  ...
                  <div class="form-group form-group-material form-group-material-outline">
                    <input type="text" name="price" class="form-control" autocomplete="off" id="form-group-material-outlined-1">
