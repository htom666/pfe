...
class EditProductEstimate extends Component
{
    public $estimate;
    public $allProducts = [];
    public $allServices = [];
    ...
    public function mount()
    {
        ...
        $this->tva = $this->estimate->tva;
        $this->ttc = $this->estimate->ttc;
        $this->price = $this->estimate->price;
        ...
        foreach ($this->estimate->products as $product) {
            $this->orderProducts [] = [
        ...
        foreach ($this->estimate->services as $service) {
            $this->orderServices [] = [
    ...
    {
        return view('livewire.edit-product-estimate');
    }
}